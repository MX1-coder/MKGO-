...
class _RegisterDetailsState extends State<RegisterDetails> {
  ...
  Future<void> getDetails() async {
    ...
    if (response.statusCode == 200) {
      ...
      DateTime dobDateTime = DateTime.parse(DOB2);
      dobDateTime = dobDateTime.toUtc();
      String formattedDate =
          "${dobDateTime.year}-${dobDateTime.month.toString().padLeft(2, '0')}-${dobDateTime.day.toString().padLeft(2, '0')}";
